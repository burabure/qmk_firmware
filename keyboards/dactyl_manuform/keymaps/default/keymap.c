...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [ARKY] = LAYOUT(
        ...
        _______, _______, _______, KC_UP,   KC_PGUP, KC_HOME,                                      KC_HOME, KC_PGUP, KC_UP,   _______, _______,    _______, \
    ...
    [NUMK] = LAYOUT(
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                                        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
        _______, _______, _______, _______, _______, _______,                                      KC_DOT,  KC_P7,   KC_P8,   KC_P9,   KC_MINS, KC_SLSH, \
        _______, _______, _______, _______, _______, _______,                                      KC_COMM, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, KC_ASTR, \
    ...
    [MOUS] = LAYOUT(
        _______, _______, _______, _______, _______, _______,                                      _______, _______, _______, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______,                                      KC_ACL0, KC_WH_U, KC_MS_U, _______, _______, _______, \
        _______, _______, _______, _______, _______, _______,                                      KC_ACL1, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, \
        _______, _______, _______, _______, _______, _______,                                      KC_ACL2, KC_WH_D, _______, _______, _______, _______, \
